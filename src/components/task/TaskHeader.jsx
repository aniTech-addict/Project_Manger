    ...
    return (
        <div className="flex items-center justify-between mb-6">
            <div className="flex items-center text-sm text-gray-500">
                <Link to="/" className="hover:text-gray-900 transition-colors">Projects</Link>
                {board && (
                    <>
                        <span className="mx-2">/</span>
                        <Link to={`/projects/${board._id}`} className="hover:text-gray-900 transition-colors">{board.title}</Link>
                    </>
                )}
                <span className="mx-2">/</span>
